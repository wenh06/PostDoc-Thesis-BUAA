...
\end{cases}
\end{equation}
以上定义的随机梯度是是梯度$\nabla F$的无偏估计。这样的方法简化了$\nabla F$的计算，提高了整体算法的收敛率\cite{Kovalev2020_loopless}。文献\parencite{hanzely2020federated}对子节点上的目标函数做了进一步的假设，即假设$f_k$有有限和的结构
\begin{equation}
...
文献\parencite{t2020pfedme}  \texttt{pFedMe}待写。。。。
