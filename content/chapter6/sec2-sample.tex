...
\addcontentsline{toe}{section}{{\thecurrentchapter .2\ \ Numerical Evaluation of the Robustness of Federated Learning Algorithms on the Participation Rate of the Clients}\numberline\,}
