...
% 约束优化问题\eqref{eq:fl-basic-constraint}的拉格朗日函数为
% \begin{equation}
% \label{eq:fl-basic-lagrangian}
% \mathcal{L}(\theta_1, \ldots, \theta_K, \theta, \lambda) = \sum\limits_{k=1}^K \left( w_k f_k(\theta_k) + \langle \lambda_k, \theta_k - \theta \rangle \right).
% \end{equation}
