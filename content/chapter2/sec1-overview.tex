...
我们注意到，相比于联邦平均算法\texttt{FedAvg}\ref{algo:fedavg}，\texttt{FedOpt}在中心节点引入了带动量 (Momentum)\index{动量, Momentum} 的项用于\textbf{ServerOpt}进行加速。我们列举一些\textbf{ServerOpt}可供选择的方法\cite{reddi2020fed_opt}：
\begin{itemize}
