...
% listings v1.11+ dropped xeCJK's expected version guard, so apply the "First Aid" manually.
% This disables XeTeX inter-character class tokens inside every listing, preventing
% the "! Improper discretionary list." emergency stop caused by \lst@@discretionary.
\makeatletter
\lst@AddToHook{PreSet}{\XeTeXinterchartokenstate=\z@}
\makeatother
...
\newCJKfontfamily\songti[Path=fonts/]{simsun.ttc}
